...
public class LuceneIndexService {
	 ...
	 * @return
	 */
	private static Document createDocument(Integer id, String title, Date datePublished, List<Author> author, String abstractContent, String fullText, String urlLink) {
