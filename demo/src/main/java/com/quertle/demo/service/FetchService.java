...
public class FetchService {
	...
	public void saveIfExists(String dataSource) {
		...
		try {
			/*
			 * if(file.exists()) { LOG.info("Deleting existing file"); file.delete(); }
			 */
	 ...
	 */
	private List<FierceNews> parseXML(byte[] content) {
	 ...
	 */
	private void setFullText(List<FierceNews> generalFierceNews) {
	 ...
	 * @param generalFierceNews
	 */
	private void loadFierceNewsInToDatabase(List<FierceNews> generalFierceNews) {
